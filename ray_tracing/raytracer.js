...
// template
var myShapeGreen = new Sphere(
    new Vector3(0, 0, -20), // center
    1, // radius
    new Material(
        new Vector3(0.0, 2.0, 0.0), // color
        0, // reflection
        0,  // transparency
        new Vector3() // emissionColor (lights only)
     )
...
var myShapeYellow = new Sphere(
    new Vector3(0, 2, -20), // center
    1, // radius
    new Material(
        new Vector3(2.0, 2.0, 0.0), // color
        0, // reflection
        0,  // transparency
        new Vector3() // emissionColor (lights only)
     )
...
scene.add(myShapeGreen)
scene.add(myShapeYellow)
scene.add(myShapeRed)
...
var lightBack = new Sphere(
    new Vector3(0, 1000, 10), // center
    1, // radius
    new Material(
        new Vector3(), // color
        0, // reflection
...
var lightSide = new Sphere(
    new Vector3(1000, 10, 10), // center
    1, // radius
    new Material(
        new Vector3(), // color
        0, // reflection
